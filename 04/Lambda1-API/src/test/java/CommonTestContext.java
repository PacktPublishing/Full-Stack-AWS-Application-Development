 ...
 */
public class CommonTestContext implements Context {
    ...
    public static AwsProxyRequest getRequest()
    {
    	AwsProxyRequest ret = new AwsProxyRequest();
    	
        HashMap<String,String> headers = new HashMap<String, String>();
        headers.put("Accept", "application/json");
        ret.setHeaders(headers);
        
    	ret.setRequestContext(new ApiGatewayRequestContext());
    	ret.getRequestContext().setAuthorizer(new ApiGatewayAuthorizerContext());
//    	
//    	ret.getRequestContext().getAuthorizer().setClaims(new CognitoAuthorizerClaims());
//    	
//    	ret.getRequestContext().getAuthorizer().getClaims().setSubject("e5308141-0660-4cc3-9398-12c204b4a7ac");
    	
    	ret.setQueryStringParameters(new HashMap<>());
