...
public class Lambda1FunctionHandler {
	...
	static
	{
		try
		{
			...
			System.out.println("Init static initializer");
...
//	    	}
	...
	//					.withNames("DBurl","DBuser","DBpass","Cognito_APP_ID","Cognito_IDENTITY_POOL_ID","Cognito_USER_POOL_ID","apiURL",
	//							"invRptSNSTopicArn","shipmentSNSTopicArn","Cognito_ACCT_ID");
